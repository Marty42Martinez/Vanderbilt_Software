function EBLike_CO, q,u,qcov,ucov,E=E,B=B, double=double, unnormalize=unnormalize,$
				verbose=verbose, maxL=maxL, pixels=pixels, $
				goodpix=goodpix, npix=npix, $
				singular=singular, r=r, add = add, svd=svd, fwhm=fwhm,simple=simple
...
ebcovmake, fwhm, npix, CE, CB, simple=simple
