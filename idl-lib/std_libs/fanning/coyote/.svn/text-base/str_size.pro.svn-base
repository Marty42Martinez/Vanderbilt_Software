...
ON_ERROR, 1
   ...
   ; Program doesn't work with hardware fonts.

IF !P.Font EQ 0 THEN BEGIN
   Message, 'This program does not support hardware fonts. Set !P.Font = -1.', /Informational
   IF N_Elements(initsize) NE 0 THEN RETURN, initsize ELSE RETURN, 1.0
ENDIF
