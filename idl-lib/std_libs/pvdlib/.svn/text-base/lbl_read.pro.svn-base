...
;-------------------------------------------------------------------------------
;
; $Id: lbl_read.pro,v 2.1 2002/05/13 18:53:21 paulv Exp $
;
; $Date: 2002/05/13 18:53:21 $
;
; $Revision: 2.1 $
;
; $State: Exp $
;
; $Log: lbl_read.pro,v $
; Revision 2.1  2002/05/13 18:53:21  paulv
; - New version. Updated to accomodate double precision LBLRTM data files.
;
