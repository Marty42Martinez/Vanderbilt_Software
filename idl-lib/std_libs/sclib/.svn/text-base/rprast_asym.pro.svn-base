FUNCTION rprast_asym,point,par,nopd=nopd,SN=SN,nogain=nogain
...
if (keyword_set(nopd) eq 0) then begin
	...
	pspsig_grad_xl=pspfwhm_xl*(1/fact)*sig_xl0*f_chop
	pspsig_curv_xl=pspfwhm_xl*(1/fact)*sig_xl0*f_chop^2	
	...
	return,float([[tods],[pspfwhm_xl],[pspfwhm_el],[psptau],[pspdelta_x],[pspdelta_y],[pspA_c],[pspsig_grad_xl], $ 
			[pspsig_curv_xl],[pspsig_grad_el],[pspsig_curv_el],[pspA]])
endif else begin
