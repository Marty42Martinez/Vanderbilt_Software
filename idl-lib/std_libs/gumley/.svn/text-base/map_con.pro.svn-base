; $Id: map_con.pro,v 1.1 1999/07/06 15:11:54 gumley Exp $
;
...
PRO map_do_seg, fnames, name, hires, bounds, zvalue, extra, POLYFILL=poly
...
if fnames[1] eq 'chigh' then begin
  fndx = 'chigh.ndx'
  dat  = 'chigh.dat'
end
if fnames[1] eq 'phigh' then begin
  fndx = 'phigh.ndx'
  dat  = 'phigh.dat'
end
help, fndx, dat
...
if rivers ne 0 then begin	;Rivers
   map_do_seg, ['rlow', 'rhigh'], 'Rivers', hires, bounds, zvalue, extra
endif				;Rivers

if countries ne 0 then begin	;*** Countries ****
   map_do_seg, ['blow', 'bhigh'], 'Boundaries', hires, bounds, $
	zvalue, extra
endif				;countries

if coasts ne 0 then begin
   map_do_seg, ['clow', 'chigh'], 'Coasts', hires, bounds, zvalue, extra
endif				;Coasts


if cont ne 0 or fill_continents ne 0 then begin
   map_do_seg, ['plow', 'phigh'], 'Continents', $
