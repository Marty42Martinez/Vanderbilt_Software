...
PRO gnomcursor, cursor_type=cursor_type
;+
;=-----------------------------------------------------------------------------
; NAME:   
;     GNOMCURSOR
...
;     selected on a Healpix of QuadCube map in Gnomview projection 
; CALLING SEQUENCE:
...
; SIDE EFFECT:
; RESTRICIONS:
;      runs on the X-window created by the latest execution of Gnomview
; PROCEDURE CALLS:
;      Gnom2pix
; HISTORY:
;       June 98 : copied by EH from 
;        coor_cursor (F.X.Desert, JUL-1992) and xcursor (R. Sterner, Nov-1993)
;       March 1999 : updated for improved Gnomview
;=-----------------------------------------------------------------------------
;-

@gnomcom ; define common
file_in = file_in1    ; to be used by gnomcursor
...
button = !err
gnom2pix, xpos, ypos, id_pix, lon_deg, lat_deg
