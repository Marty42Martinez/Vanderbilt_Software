pro planet_coords, date, ra, dec, dist, angularsize, planet=planet, jd = jd
;+
; NAME:
;    PLANET_COORDS
; PURPOSE:
...
; 		DIST - The distance to the planet [AU]
;		ANGULARSIZE - The apparaent angular size of the planet as viewed from Earth in arcseconds
;
...
;		 Added Distance and Angular Size Output, Chris O'Dell July 2002
;-
 On_error,2
...
;get rectangular coords of planets (with respect to earth position)
...
; get distance to earth in AU
   dist = sqrt(x^2 + y^2 + z^2)

; get apparent angular size of planet in arcseconds
sizes = [4880., 12103.,12756.,6794.,142984.,120536.,51118.,49528.,2340.]
au2km = 149597870.7 ; 1 AU expressed in km
if n_elements(index) gt 1 then begin
	angularsize = sizes[index-1]/(dist*au2km) * 180./!pi * 3600.
endif else angularsize = sizes[index[0]-1]/(dist*au2km) * 180./!pi * 3600.
