; RB: Changed this slightly to allow for unselecting aan excluvie button....
; Aug 28 2015
...
pro CW_BGROUP_SETV, id, value
  ...
  case state.type of
    ...
    1: begin
      ; addrd if statement and unselect option for exclusive buttons
      ; RB aug 28 2015
      ; e.g. use: WIDGET_CONTROL, bgroup1,set_value=-1
      ; to unselect...
